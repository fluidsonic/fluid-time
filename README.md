...
[![Kotlin](https://img.shields.io/badge/Kotlin-1.4.20%20(Darwin,%20JS,%20JVM)-blue.svg)](https://github.com/JetBrains/kotlin/releases/v1.4.20)
...
```kotlin
dependencies {
	implementation("io.fluidsonic.time:fluid-time:0.11.0")
}
```
