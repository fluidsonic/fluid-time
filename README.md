...
[![kotlinx-datetime](https://img.shields.io/badge/kotlinx--datetime-0.7.1-blue.svg)](https://github.com/Kotlin/kotlinx-datetime/releases/tag/v0.7.1)
...
- **JVM** and **JS** are supported.

Previous library
----------------

Before `kotlinx-datetime` was released this library has provided its own date & time implementations for JVM. That work has been discontinued in
